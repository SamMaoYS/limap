...
from loader import read_scene_multiscan
...
def run_scene_multiscan(cfg, dataset, scene_id):
    imagecols, neighbors, depths = read_scene_multiscan(
...
def parse_config():
    ...
    arg_parser.add_argument(
        ...
        "--config_file",
        type=str,
        default="cfgs/fitnmerge/multiscan.yaml",
        help="config file",
    )
    arg_parser.add_argument(
        "--default_config_file",
    ...
    cfg["folder_to_load"] = os.path.join("precomputed", "multiscan", cfg["scene_id"])
    return cfg
